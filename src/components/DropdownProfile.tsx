    ...
    <div className="relative inline-flex">
      ...
      <Transition
        ...
        >
          ...
          <ul>
            <li>
              <Link className="font-medium text-sm hover:text-[#16c47f] dark:hover:text-[#16c49f] dark:hover:text-violet-400 flex items-center py-1 px-3"
               style={{ color: "#16c47f" }}
              to="/">
                Settings
              </Link>
            ...
            <li>
              <Link className="font-medium text-sm hover:text-[#16c47f] dark:hover:text-[#16c49f] dark:hover:text-violet-400 flex items-center py-1 px-3" to="/"  style={{ color: "#16c47f" }}>
                Sign Out
              </Link>
            </li>
          </ul>
